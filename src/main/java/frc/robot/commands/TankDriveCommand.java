...
public class TankDriveCommand extends CommandBase {
    ...
    public TankDriveCommand(DriveBase driveBase, DoubleSupplier leftPowerSupplier, DoubleSupplier rightPowerSupplier,
    ...
    @Override
    public void execute() {
        driveBase.tankDrive(leftPowerSupplier.getAsDouble(), rightPowerSupplier.getAsDouble(), squareInputs.getAsBoolean());
    }
